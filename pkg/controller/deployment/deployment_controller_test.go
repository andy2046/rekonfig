...
// TestDeploymentController runs Reconcile() against a fake client.
func TestDeploymentController(t *testing.T) {
	...
	// Create a ReconcileDeployment object with the scheme and fake client.
	r := &ReconcileDeployment{handler: h, scheme: s}
